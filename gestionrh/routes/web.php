...
Route::middleware('userAdmin')->group(function(){
    ...
    Route::prefix('article')->group(function(){
        ...
        Route::post('bon_sortie',[ArticleController::class,'bon_sortie'])->name('article.bon_sortie');
    });
    ...
    Route::prefix('fourniture')->group(function(){
        ...
        Route::put('/valid_sup/{fourniture}',[FournitureController::class,'valid_sup'])->name('fourniture.valid_sup');
    ...
    Route::prefix('parking')->group(function(){
        ...
        Route::get('reponse/{parking}',[ParkingController::class, 'reponse'])->name('parking.reponse');
        Route::put('update_reponse/{parking}',[ParkingController::class,'update_reponse'])->name('parking.update_reponse');
        ...
        Route::get('validation_accepted',[ParkingController::class, 'validation_accepted'])->name('parking.validation_accepted');
    ...
    Route::prefix('ordre_mission')->group(function(){
        ...
        // Route::post('store_mission',[OrdreMissionController::class,'store_mission'])->name('ordre_mission.mission_store');
