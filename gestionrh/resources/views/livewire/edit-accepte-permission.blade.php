    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="" method="POST" wire:submit.prevent="update">
                ...
                <div class="mt-3">
                    <label for="id_statut_permission_rh">Changement final du statut de la demande</label>
                    <select name="id_statut_permission_rh" id="" class="form-select" wire:model.live="id_statut_permission_rh">
                        <option value="">--- Changer le statut de la demande ---</option>
                        @foreach ($statut_permission as $statut)
                        <option value="{{$statut->id}}">{{$statut->statut_demande_rh}}</option>
                        @endforeach
                    </select>
                </div>
                <div>
                ...
                {{-- <div class="mt-3">
                    ...
                    <select name="id_responsable" id="id_responsable" class="form-select" wire:model.live="id_responsable" readonly>
