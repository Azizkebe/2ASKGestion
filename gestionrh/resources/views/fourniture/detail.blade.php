        ...
        <div class="card">
                <div class="card-header">
                    ...
                    {{-- <button class="btn btn-primary btn-round ms-auto">
                        <a href="" class="text-white"><i class="fa fa-plus"></i> Ajouter un article</a>
                    </button> --}}
                    </div>
                </div>
              <div class="card-body">
                    ...
                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                          <div class="modal-content">
                            ...
                            <form action="{{route('fourniture.detail_save', $fourni)}}" method="POST">
                                @csrf
                                @method('POST')
                  ...
                  <thead>
                    <tr>
                      ...
                      <th style="width: 10%">Action</th>
                          ...
                          <tbody>
                           @forelse ($panier_fourni as $detail)
                          <tr>
                              <td>{{$detail->id}}</td>
